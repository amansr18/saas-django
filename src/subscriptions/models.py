...
SUBSCRIPTION_PERMISSIONS = [
            ("advanced",  "Advanced Perm"), # sunscriptions.advanced
...
class Subscription(models.Model):
    ...
    limit_choices_to={"content_type__app_label": "subscriptions", "codename__in": [x[0]for x in SUBSCRIPTION_PERMISSIONS]})
    ...
    def save(self, *args, **kwargs):
        ...
        super().save(*args, **kwargs) # anything below -save will not update in database
...
def user_sub_post_save(sender, instance, *args, **kwargs):
    ...
    if not ALLOW_CUSTOM_GROUPS:
        ...
        # group_ids = groups.values_list("id", flat=True) # [1, 2, 3]
